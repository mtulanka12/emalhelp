    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          </li><li class="nav-item" id="logout">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                $studentCount=     mysqli_fetch_assoc($result);
                //                  echo($result);
                ?>
                <h3><?= $studentCount['StudentCount'] ?></h3>
              ...
              <a href="../Exams/pages/Student/StudentList.php" class="small-box-footer">Students Manage <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <?php
                $sql="select count(*) as TeacherCount from teacher;";
                $result=mysqli_query($conn,$sql);
                $TeacherCount=     mysqli_fetch_assoc($result);
                //                  echo($result);
                ?>
                <h3><?= $TeacherCount['TeacherCount'] ?></h3>
              ...
              <a href="../Exams/pages/teacher/TeacherList.php" class="small-box-footer">Teachers Manage <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
