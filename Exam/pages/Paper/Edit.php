    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open " id="managePapers">
      ...
      <div class="container-fluid">
        <div class="card card-warning">
            ...
            <form id="savePaper">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <input type="text" id="id" name="id" class="form-control" value="<?= $Paper['id'] ?>"
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="row">
                    <div class="col-sm-12">
                      <label>Low difficulty question count <span style="color: red">*</span> </label>

                      </br><label style="font-weight: 500" id="lowCount"><?= $Paper['question_low'] ?></label>
                      <input type="range" style="color: green;accent-color: currentcolor" min="0" id max="15"
                             onchange="updateLow(value)" step="1" id="lowCountValue" name="lowCountValue"
                             class="form-control" value="<?= $Paper['question_low'] ?>" required>
                    </div>
                    <div class="col-sm-12">
                      <label>Medium difficulty question count <span style="color: red">*</span> </label>
                      </br><label style="font-weight: 500" id="mediumCount"><?= $Paper['question_medium'] ?></label>
                      <input type="range" min="0" style="color: darkorchid;accent-color: currentcolor" id max="15"
                             onchange="updateMedium(value)" step="1" id="mediumCountValue" name="mediumCountValue"
                             class="form-control" value="<?= $Paper['question_medium'] ?>" required>
                    </div>
                    <div class="col-sm-12">
                      <label>High difficulty question count <span style="color: red">*</span> </label>
                      </br><label style="font-weight: 500" id="highCount"><?= $Paper['question_high'] ?></label>
                      <input type="range" min="0" style="color: red;accent-color: currentcolor" id max="15"
                             onchange="updateHigh(value)" step="1" id="highCountValue" name="highCountValue"
                             class="form-control" value="<?= $Paper['question_high'] ?>" required>
                    </div>
                    <div class="col-sm-12">
                      <label>Random difficulty question count <span style="color: red">*</span> </label>
                      </br><label style="font-weight: 500" id="randomCount"><?= $Paper['question_random'] ?></label>
                      <input type="range" min="0" id max="15" style="color: #af369f;accent-color: currentcolor"
                             onchange="updateRandom(value)" step="1" id="randomCountValue" name="randomCountValue"
                             class="form-control" value="<?= $Paper['question_random'] ?>" required>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  ...
                  <div class="col-sm-12"><label>Total Question <span style="color: red">*</span> </label>
                    </br>
                    <label style=" font-size: 70px; font-weight: 500" id="Total_question"><?= $Total ?></label>

                  </div>
                  <div class="col-sm-12"><label>Name <span style="color: red">*</span> </label>
                    </br>
                    <input type="text" id="type" value="<?= $Paper['type'] ?>"
                           name="type" class="form-control" required>
                  </div>
                  <div class="col-sm-12"><label>Grade <span style="color: red">*</span> </label>
                    </br>
                    <input type="text" id="grade" value="<?= $Paper['grade'] ?>"
          ...
          <div class="row" style="margin-top: 10px">
            <div class="col-sm-12">
              <input type="button" value="Save " onclick="EditPaper()"
                     class="btn btn-warning align-self-center"
                     style=" color: white; align-content: center">
