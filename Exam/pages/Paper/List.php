          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th>Subject</th>
                <th>Name</th>
                <th>low question count</th>
                <th>medium question count</th>
                <th>High question count</th>
                <th>Random question count</th>
                <th>Time duration</th>
                <th>Grade</th>
                <th>Action</th>
              </tr>
              ...
              if (mysqli_num_rows($result) > 0) {
                foreach ($result
                  ...
                  <tr>
                    ...
                    <td><?= $Paper['type'] ?></td>
                    <td><?= $Paper['question_low'] ?></td>
                    <td><?= $Paper['question_medium'] ?></td>
                    <td><?= $Paper['question_high'] ?></td>
                    <td><?= $Paper['question_random'] ?></td>
