              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      </br><label style="font-weight: 500" id="lowCount">0</label>
                    ...
                    <div class="col-sm-12">
                      ...
                      </br><label style="font-weight: 500" id="mediumCount">0</label>
                    ...
                    <div class="col-sm-12">
                      ...
                      </br><label style="font-weight: 500" id="highCount">0</label>
                    ...
                    <div class="col-sm-12">
                      ...
                      </br><label style="font-weight: 500" id="randomCount">0</label>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="col-sm-12"><label>Total Question <span style="color: red">*</span> </label>
                    ...
                    <label style=" font-size: 70px; font-weight: 500" id="Total_question">0</label>
