      ...
      <div class="container-fluid">
        <div class="card card-warning">
          <div class="card-header">
            <h3 class="card-title" style="color: white">Subjects Details[Edit]</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form id="saveSubject">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="id" name="teacherId" value="<?= $Subject['id'] ?>" class="form-control"
                           placeholder="Auto Assign" disabled>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" id="grade" name="grade" class="form-control" placeholder="Enter ..."
          ...
          <div class="row" style="margin-top: 10px">
            <div class="col-sm-8">
              <input type="button" value="Save Subject " onclick="EditSubject()"
