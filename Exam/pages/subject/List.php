      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">All Subjects List</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="post" action="Edit.php">
                        <input name="id" value="<?= $Subject['id'] ?>" style="display: none">
                        ...
                        <button type="button" class="btn btn-danger deleteSubject" value="<?= $Subject['id'] ?>"><i
                            style="color: white"
