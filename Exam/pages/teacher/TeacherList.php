      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open" id="ManageTeacher">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../teacher/TeacherList.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>list</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">Teachers List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              if (mysqli_num_rows($result) > 0) {
                foreach ($result
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="post" action="TeacherEdit.php">
                        ...
                        <button type="button" class="btn btn-danger deleteTeacher" value="<?= $teacher['id'] ?>"><i
                            style="color: white"
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (res.code == 220) {
            ...
            $("#example1").load("TeacherList.php #example1");
            alert(' Deleted');
