        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open" id="ManageTeacher">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../teacher/AddTeacher.php" id="studentAdd" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Teacher's Details</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form id="saveTeacher">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="qualification" id="qualification" name="qualification" class="form-control"
                           placeholder="Enter ...">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="number" id="mobileNo" name="phoneNo" class="form-control" rows="3"
                           placeholder="Enter ..." required/>
                  </div>
                </div>
              </div>
