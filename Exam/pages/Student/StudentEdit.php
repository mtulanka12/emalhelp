...
if (isset($_POST['search'])) {
  ...
  $Student=SearchStudent($student_id,$conn);
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open" id="ManageStudent">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="AddStudent.php" id="studentAdd" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add</p>
                </a>
              </li>
              <li class="nav-item ">
                <a href="StudentEdit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit</p>
                </a>
              </li>
          ...
          </li>   <li class="nav-item  " id="managePassPapers" >
            <a href="#" class="nav-link ">
              <i class="fas fa-book"></i>
      ...
      <div class="container-fluid">
        <div class="card card-warning">
          <div class="card-header">
            <h3 class="card-title" style="color: white">Student Details [Edit]</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="StudentId"  id="StudentId"  class="form-control" value="<?= $Student['student_id']?>" placeholder="Enter ..." disabled>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Name <span style="color: red">*</span> </label>
                  <input type="text" value="<?= $Student['name']?>" id="name" name="Name" class="form-control" placeholder="Enter ..." required>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="<?= $Student['nic']?>" name="nic" id="nic" class="form-control" placeholder="Enter ..." required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Address <span style="color: red">*</span> </label>
                  <textarea name="address" id="address" class="form-control" rows="3" placeholder="Enter ..." required><?= $Student['address']?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" id="gender_male" <?= $gender_male?> name="gender"  required>
                    <label class="form-check-label">Male</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="gender_female" <?= $gender_female?>  required>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" value="<?= $Student['username']?>" name="username"  id="username" class="form-control" placeholder="Enter ..." required>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="password" id="confirmPassword" name="ConfirmPassword" class="form-control" placeholder="Enter ..." required>
                </div>
              </div>
            </div>
            <hr>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="email" id="email" required name="email" value="<?= $Student['email']?>" class="form-control" placeholder="Enter ..." required/>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Mobile No <span style="color: red">*</span> </label>
                  <input type="number" id="mobileNo" name="phoneNo" value="<?= $Student['mobileNo']?>" class="form-control" rows="3" placeholder="Enter ..."
                         required/>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <input type="submit" value="Save Student " onclick="EditStudent()" class="btn btn-warning align-self-center"
