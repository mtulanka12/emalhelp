        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open" id="ManageStudent">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="StudentList.php" class="nav-link active">
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="post" action="StudentEdit.php">
                        <input name="student_id" value="<?= $student['student_id'] ?>" style="display: none">
                        ...
                        <button type="button" class="btn btn-danger deleteStudent"
                                value="<?= $student['student_id'] ?>"><i style="color: white"
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (res.code == 220) {
            ...
            $("#example1").load("StudentList.php #example1");
            alert(' Deleted');
