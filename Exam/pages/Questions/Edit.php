...
function SearchPaper($id, $conn)
{
  ...
  $sql = "SELECT p.id,t.name AS teacher,s.name AS subject,p.type FROM paper AS p LEFT JOIN teacher AS t ON (t.id=p.teacher_id) LEFT JOIN subject AS s ON(s.id=p.subject_id)  where p.id= $id";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Questions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item ">Edit Questions</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="card card-warning">
          <div class="card-header">
            <h3 class="card-title" style="color: white">Questions Details[Edit]</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form id="saveQuestions">
              <div class="row">
                <div class="col-sm-12">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="teacher" id="teacher">
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        foreach ($result as $paper) {
                          ...
                          if ($Paper['teacher'] == $paper['name']) {
                            $selected = 'selected';
                          }

                          ?>
                          <option <?= $selected ?> value="<?= $paper['id'] ?>"><?= $paper['name'] ?></option>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" id="type" name="type" class="form-control" placeholder="Enter ..." value="<?=$Paper['type']?>" required>
                </div>
              </div>
              <div class="row" style="margin-top: 10px">
                <div class="col-sm-8">
                  <input type="button" value="Save Question " onclick="EditPaper()"
...
</script><script src="../../plugins/auth/auth.js"></script>
</body>
</html>
